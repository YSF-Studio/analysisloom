...
fn main() {
    ...
    for line in stdin.lock().lines() {
        ...
        let req: Value = serde_json::from_str(&line)
            .unwrap_or_else(|e| json!({ "id": 0, "ok": false, "error": format!("bad json: {e}") }));
...
fn dispatch(rt: &tokio::runtime::Runtime, cmd: &str, args: &Value) -> Result<Value, String> {
    match cmd {
        ...
        "list_cases" => {
            Ok(serde_json::to_value(commands::list_cases()?).map_err(|e| e.to_string())?)
        }
        ...
        "get_case" => Ok(
            serde_json::to_value(commands::get_case(arg_str(args, "caseId")?)?)
                .map_err(|e| e.to_string())?,
        ),
        "delete_case" => {
        ...
        "parse_mft" => Ok(
            serde_json::to_value(commands::parse_mft(arg_str(args, "imagePath")?)?)
                .map_err(|e| e.to_string())?,
        ),
        "start_carving" => {
        ...
        "get_carving_progress" => {
            Ok(serde_json::to_value(commands::get_carving_progress()?)
                .map_err(|e| e.to_string())?)
        }
        "cancel_carving" => {
        ...
        "get_carving_result" => {
            Ok(serde_json::to_value(commands::get_carving_result()).map_err(|e| e.to_string())?)
        }
        "hash_file" => Ok(
            serde_json::to_value(commands::hash_file(arg_str(args, "path")?)?)
                .map_err(|e| e.to_string())?,
        ),
        "preview_file" => Ok(
            serde_json::to_value(commands::preview_file(arg_str(args, "path")?)?)
                .map_err(|e| e.to_string())?,
        ),
        "sqlite_db_info" => Ok(serde_json::to_value(commands::sqlite_db_info(arg_str(
            args, "path",
        )?)?)
        .map_err(|e| e.to_string())?),
        ...
        .map_err(|e| e.to_string())?),
        "detect_encrypted" => Ok(serde_json::to_value(commands::detect_encrypted(arg_str(
            args,
            "imagePath",
        )?)?)
        .map_err(|e| e.to_string())?),
        ...
        "list_evidence" => Ok(serde_json::to_value(commands::list_evidence(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        "list_findings" => Ok(serde_json::to_value(commands::list_findings(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        "case_stats" => Ok(
            serde_json::to_value(commands::case_stats(arg_str(args, "caseId")?)?)
                .map_err(|e| e.to_string())?,
        ),
        ...
        "get_timeline" => Ok(serde_json::to_value(commands::get_timeline(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        "get_super_timeline" => Ok(serde_json::to_value(commands::get_super_timeline(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        ...
        "list_bookmarks" => Ok(serde_json::to_value(commands::list_bookmarks(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        "delete_bookmark" => {
        ...
        "get_audit_log" => Ok(serde_json::to_value(commands::get_audit_log(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        ...
        "analyze_registry_hive" => Ok(serde_json::to_value(commands::analyze_registry_hive(
            arg_str(args, "path")?,
        )?)
        .map_err(|e| e.to_string())?),
        "scan_registry_directory" => Ok(serde_json::to_value(commands::scan_registry_directory(
            arg_str(args, "dir")?,
        )?)
        .map_err(|e| e.to_string())?),
        ...
        "analyze_antiforensics_mft" => Ok(serde_json::to_value(
            commands::analyze_antiforensics_mft(arg_str(args, "imagePath")?)?,
        )
        .map_err(|e| e.to_string())?),
        "analyze_antiforensics_files" => Ok(serde_json::to_value(
            commands::analyze_antiforensics_files(arg_vec_str(args, "paths")?)?,
        )
        .map_err(|e| e.to_string())?),
        "scan_browser_artifacts" => Ok(serde_json::to_value(commands::scan_browser_artifacts(
            arg_str(args, "root")?,
        )?)
        .map_err(|e| e.to_string())?),
        "analyze_browser_db" => Ok(serde_json::to_value(commands::analyze_browser_db(arg_str(
            args, "path",
        )?)?)
        .map_err(|e| e.to_string())?),
        "nsrl_lookup_file" => Ok(serde_json::to_value(commands::nsrl_lookup_file(arg_str(
            args, "path",
        )?)?)
        .map_err(|e| e.to_string())?),
        "nsrl_lookup_hash" => Ok(serde_json::to_value(commands::nsrl_lookup_hash(arg_str(
            args, "sha256",
        )?)?)
        .map_err(|e| e.to_string())?),
        ...
        "parse_volatility_json" => Ok(serde_json::to_value(commands::parse_volatility_json(
            arg_str(args, "path")?,
        )?)
        .map_err(|e| e.to_string())?),
        "about_info" => Ok(commands::about_info()),
        "parse_evtx_log" => Ok(serde_json::to_value(commands::parse_evtx_log(arg_str(
            args, "path",
        )?)?)
        .map_err(|e| e.to_string())?),
        "scan_evtx_directory" => Ok(serde_json::to_value(commands::scan_evtx_directory(arg_str(
            args, "dir",
        )?)?)
        .map_err(|e| e.to_string())?),
        "scan_macos_artifacts" => Ok(serde_json::to_value(commands::scan_macos_artifacts(
            arg_str(args, "root")?,
        )?)
        .map_err(|e| e.to_string())?),
        "analyze_macos_plist" => Ok(serde_json::to_value(commands::analyze_macos_plist(arg_str(
            args, "path",
        )?)?)
        .map_err(|e| e.to_string())?),
        "analyze_pcap" => Ok(
            serde_json::to_value(commands::analyze_pcap(arg_str(args, "path")?)?)
                .map_err(|e| e.to_string())?,
        ),
        ...
        "verify_evidence_integrity" => {
            Ok(serde_json::to_value(commands::verify_evidence_integrity(
                arg_str(args, "caseId")?,
                arg_str(args, "filePath")?,
        ...
        "list_case_notes" => Ok(serde_json::to_value(commands::list_case_notes(arg_str(
            args, "caseId",
        )?)?)
        .map_err(|e| e.to_string())?),
        ...
        .map_err(|e| e.to_string())?),
        "scan_steganography" => Ok(serde_json::to_value(commands::scan_steganography(
            arg_vec_str(args, "paths")?,
        )?)
        .map_err(|e| e.to_string())?),
        "analyze_steganography" => Ok(serde_json::to_value(commands::analyze_steganography(
            arg_str(args, "path")?,
        )?)
        .map_err(|e| e.to_string())?),
        "scan_email_directory" => Ok(serde_json::to_value(commands::scan_email_directory(
            arg_str(args, "dir")?,
        )?)
        .map_err(|e| e.to_string())?),
        "scan_chat_artifacts" => Ok(serde_json::to_value(commands::scan_chat_artifacts(arg_str(
            args, "root",
        )?)?)
        .map_err(|e| e.to_string())?),
        "scan_linux_artifacts" => Ok(serde_json::to_value(commands::scan_linux_artifacts(
            arg_str(args, "root")?,
        )?)
        .map_err(|e| e.to_string())?),
        "list_forensic_plugins" => {
            Ok(serde_json::to_value(commands::list_forensic_plugins())
                .map_err(|e| e.to_string())?)
        }
